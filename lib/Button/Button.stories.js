...
const buttonClickHandler = action('button-click')
...
stories.add('Demo', () =>
  <div className='ButtonDemo'>
    <div>
      <h3>按钮类型及 skin</h3>
      <Button id='btn1-1' onClick={buttonClickHandler}>默认按钮</Button>
      <Button id='btn1-2' onClick={buttonClickHandler} skin='primary'>skin=primary</Button>
      <Button id='btn1-3' onClick={buttonClickHandler} skin='danger'>skin=danger</Button>
      <Button id='btn1-4' onClick={buttonClickHandler} skin='ignore'>skin=ignore</Button>
      <Button id='btn1-5' onClick={buttonClickHandler} skin='link'>skin=link</Button>
      <p>对应的 disabled</p>
      <Button id='btn1-1-1' disabled onClick={buttonClickHandler}>默认按钮</Button>
      <Button id='btn1-2-1' disabled onClick={buttonClickHandler} skin='primary'>skin=primary</Button>
      <Button id='btn1-3-1' disabled onClick={buttonClickHandler} skin='danger'>skin=danger</Button>
      <Button id='btn1-4-1' disabled onClick={buttonClickHandler} skin='ignore'>skin=ignore</Button>
      <Button id='btn1-5-1' disabled onClick={buttonClickHandler} skin='link'>skin=link</Button>
    </div>
    <div>
      <h3>Icon Button</h3>
      <p>可以直接嵌入，但注意嵌入内容不受控制，要考虑浏览器支持等实际状况，暂时没搞内置的 icon ...</p>
      <Button id='btn3-1' onClick={buttonClickHandler}>☺ 表情文字按钮</Button>
      <Button id='btn3-2' onClick={buttonClickHandler}>
        <svg style={{
          width: 18,
          height: 18,
    ...
    <div>
      <h3>Button Group</h3>
      <Button.Group>
        <Button id='btn4-1' onClick={buttonClickHandler}>L</Button>
        <Button id='btn4-2' onClick={buttonClickHandler}>M</Button>
        <Button id='btn4-3' onClick={buttonClickHandler}>R</Button>
      </Button.Group>
    </div>
    <div>
...
stories.add('Custom', () => {
  ...
  return (
    <Button id='aaa' skin={skin} disabled={disabled} onClick={buttonClickHandler} style={style}>
      {label}
    </Button>
  )
})
