...
stories.add('Demo', () =>
  <div className='ButtonDemo'>
    <div>
      ...
      <Button id='btn1-3' onClick={buttonClickHandler} skin='dashed'>skin=dashed</Button>
      <Button id='btn1-4' onClick={buttonClickHandler} skin='danger'>skin=danger</Button>
      ...
      <Button id='btn1-3-1' disabled onClick={buttonClickHandler} skin='dashed'>skin=dashed</Button>
      <Button id='btn1-4-1' disabled onClick={buttonClickHandler} skin='danger'>skin=danger</Button>
