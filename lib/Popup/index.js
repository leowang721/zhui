...
export default class Popup extends Component {
  ...
  static propTypes = {
    mask: PropTypes.bool,
    maskType: PropTypes.oneOf(['white', 'black']),
  ...
  getAlignStyles () {
    const {alignElement, alignPosition} = this.props

    // 计算 alignElement 的位置
    if (alignElement) {
      return domUtil.getRelativeOffset(this.contentDom, alignElement, alignPosition)
    }
  }
  ...
  getComponent () {
    ...
    return (
      <div className={ctrlClassNames} ref={dom => { this.content = dom }}>
